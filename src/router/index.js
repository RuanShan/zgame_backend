...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'edit/:code/:id',
        component: () => import('@/views/othergameround/step'),
        name: 'GameroundEdit',
        meta: { title: '管理活动', icon: 'list' },
        hidden: true
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'Upgrade',
        meta: { title: '会员升级', icon: 'user', noCache: true }
      },
      {
        path: 'transaction',
        component: () => import('@/views/profile/transaction'),
        name: 'Transaction',
        meta: { title: '财务明细', icon: 'user', noCache: true }
      }
    ]
  }
]
