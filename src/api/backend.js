...
export const getGameType = (data) => fetch(basePath + '/gametypes/getGameType', data, 'POST')
export const getGameTypeByType = (data) => fetch(basePath + '/gametypes/getGameTypeByType', data, 'POST')
